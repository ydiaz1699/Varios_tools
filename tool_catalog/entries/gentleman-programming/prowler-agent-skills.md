...
reference:
  ...
  kind: github
related:
  - "Conocimiento destilado (leer ANTES de clonar) — tools_AI/skills/skill-creator/references/prowler-case-study.md"
  - "Ficha del video — tool_catalog/entries/gentleman-programming/agents-skills-video.md"
  - "Video Gentleman (fuente) — https://www.youtube.com/watch?v=Nvn6s3r9ZAw"
  ...
  - "Implementación propia — nas-dotfiles .kiro/skills/ (PRs #148/#149/#150)"
status: APLICADO
