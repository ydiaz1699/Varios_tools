...
reference:
  ...
  kind: web
related:
  - "Fuente del patrón auto-invoke — tool_catalog/entries/gentleman-programming/prowler-agent-skills.md"
  - "Implementación propia — nas-dotfiles .kiro/skills/skill-creator"
status: APLICADO
